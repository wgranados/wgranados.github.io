class Day():
    ...
    def __init__(self, day=1, month='January', year=2012):
...
class Event():
    ...
    def __str__(self):
        ...
        return ("Event:" + str(self._name) + ": Starts at: "+ str(self._start_time) +
                " Ends at: " + str(self._end_time))
    ...
    def overlaps(self, other):
        ...
        return not (other._end_time <= self._start_time 
                    or other._start_time >= self._end_time)
